let jokeArray = [
    ...
    "0What’s a private investigator’s favorite shoe? Sneak-ers.",
    "What did the limestone say to the geologist? Don’t take me for granite!",
    "If an electric train is traveling south at 0 miles per hour and the wind is blowing North at 0 miles per hour, which way does the smoke blow? Fooled you! Electric trains don’t blow smoke.",
    ...
    "0 What do you call a tired bull? A bulldozer.",
    ...
    const myFun = () => {
        let randomNum = Math.floor(Math.random() * jokeArray.length)
        document.getElementById("get").innerHTML = jokeArray[randomNum]
    }
// for copy text
    function copyText() {
        let divElement = document.getElementById("get");
